...
7, 8, and 11, latest two non-LTS JDKs 13 and 14 on both little- and big- endian platforms.
...
See *http://javadoc.io/doc/net.openhft/zero-allocation-hashing/0.11[JavaDocs]* for more
information.
