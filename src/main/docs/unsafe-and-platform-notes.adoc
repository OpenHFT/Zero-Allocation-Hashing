...
* `requires static jsr305` declares the optional nullability-annotation dependency.
Applications inspecting those annotations must supply and resolve `jsr305`; ordinary hashing does not require it at runtime.
