...
public class WyHash {
    ...
    private long _wymum(long lhs, long rhs) {
        //The Grade School method of multiplication is a hair faster in Java, primarily used here because the implementation is simpler.
    ...
    <T> long wyHash64(long seed, T input, Access<T> access, long off, long length) {
        if(length <= 0)
            ...
            return _wymum(_wymum(_wyr3(access, input,off,length)^seed^_wyp0,seed^_wyp1)^seed,length^_wyp4);
        else if(length<=8)
            return _wymum(_wymum(_wyr4(access, input, off) ^ seed ^ _wyp0, _wyr4(access, input, off + length - 4) ^ seed ^ _wyp1) ^ seed, length ^ _wyp4);
        else if(length<=16)
            return _wymum(_wymum(__wyr8(access, input,off)^seed^_wyp0,__wyr8(access, input,off+length-8)^seed^_wyp1)^seed,length^_wyp4);
        else if(length<=24)
            return _wymum(_wymum(__wyr8(access, input,off)^seed^_wyp0,__wyr8(access, input,off+8)^seed^_wyp1)^_wymum(__wyr8(access, input,off+length-8)^seed^_wyp2,seed^_wyp3),length^_wyp4);
        else if(length<=32)
            return _wymum(_wymum(__wyr8(access, input,off)^seed^_wyp0,__wyr8(access, input,off+8)^seed^_wyp1)^_wymum(__wyr8(access, input,off+16)^seed^_wyp2,__wyr8(access, input,off+length-8)^seed^_wyp3),length^_wyp4);
        long see1=seed; long i=length, p=off;
        for(;i>256;i-=256,p+=256){
            seed = _wymum(_wyr8(access, input, p) ^ seed ^ _wyp0, _wyr8(access, input, p + 8) ^ seed ^ _wyp1) ^
                   _wymum(_wyr8(access, input, p + 16) ^ seed ^ _wyp2, _wyr8(access, input, p + 24) ^ seed ^ _wyp3);
            see1 = _wymum(_wyr8(access, input, p + 32) ^ see1 ^ _wyp1, _wyr8(access, input, p + 40) ^ see1 ^ _wyp2) ^
                   _wymum(_wyr8(access, input, p + 48) ^ see1 ^ _wyp3, _wyr8(access, input, p + 56) ^ see1 ^ _wyp0);
            seed = _wymum(_wyr8(access, input, p + 64) ^ seed ^ _wyp0, _wyr8(access, input, p + 72) ^ seed ^ _wyp1) ^
                   _wymum(_wyr8(access, input, p + 80) ^ seed ^ _wyp2, _wyr8(access, input, p + 88) ^ seed ^ _wyp3);
            see1 = _wymum(_wyr8(access, input, p + 96) ^ see1 ^ _wyp1, _wyr8(access, input, p + 104) ^ see1 ^ _wyp2) ^
                   _wymum(_wyr8(access, input, p + 112) ^ see1 ^ _wyp3, _wyr8(access, input, p + 120) ^ see1 ^ _wyp0);
            seed = _wymum(_wyr8(access, input, p + 128) ^ seed ^ _wyp0, _wyr8(access, input, p + 136) ^ seed ^ _wyp1) ^
                   _wymum(_wyr8(access, input, p + 144) ^ seed ^ _wyp2, _wyr8(access, input, p + 152) ^ seed ^ _wyp3);
            see1 = _wymum(_wyr8(access, input, p + 160) ^ see1 ^ _wyp1, _wyr8(access, input, p + 168) ^ see1 ^ _wyp2) ^
                   _wymum(_wyr8(access, input, p + 176) ^ see1 ^ _wyp3, _wyr8(access, input, p + 184) ^ see1 ^ _wyp0);
            seed = _wymum(_wyr8(access, input, p + 192) ^ seed ^ _wyp0, _wyr8(access, input, p + 200) ^ seed ^ _wyp1) ^
                   _wymum(_wyr8(access, input, p + 208) ^ seed ^ _wyp2, _wyr8(access, input, p + 216) ^ seed ^ _wyp3);
            see1 = _wymum(_wyr8(access, input, p + 224) ^ see1 ^ _wyp1, _wyr8(access, input, p + 232) ^ see1 ^ _wyp2) ^
                   _wymum(_wyr8(access, input, p + 240) ^ see1 ^ _wyp3, _wyr8(access, input, p + 248) ^ see1 ^ _wyp0);
        }
        for (; i > 32; i -= 32, p += 32) {
            seed = _wymum(_wyr8(access, input, p) ^ seed ^ _wyp0, _wyr8(access, input, p + 8) ^ seed ^ _wyp1);
            see1 = _wymum(_wyr8(access, input, p + 16) ^ see1 ^ _wyp2, _wyr8(access, input, p + 24) ^ see1 ^ _wyp3);
        }
        if (i < 4) {
            seed = _wymum(_wyr3(access, input, p, i) ^ seed ^ _wyp0, seed ^ _wyp1);
        } else if (i <= 8) {
            seed = _wymum(_wyr4(access, input, p) ^ seed ^ _wyp0, _wyr4(access, input, p + i - 4) ^ seed ^ _wyp1);
        } else if (i <= 16) {
            seed = _wymum(__wyr8(access, input, p) ^ seed ^ _wyp0, __wyr8(access, input, p + i - 8) ^ seed ^ _wyp1);
        } else if (i <= 24) {
            seed = _wymum(__wyr8(access, input, p) ^ seed ^ _wyp0, __wyr8(access, input, p + 8) ^ seed ^ _wyp1);
            see1 = _wymum(__wyr8(access, input, p + i - 8) ^ see1 ^ _wyp2, see1 ^ _wyp3);
        } else {
            seed = _wymum(__wyr8(access, input, p) ^ seed ^ _wyp0, __wyr8(access, input, p + 8) ^ seed ^ _wyp1);
            see1 = _wymum(__wyr8(access, input, p + 16) ^ see1 ^ _wyp2, __wyr8(access, input, p + i - 8) ^ see1 ^ _wyp3);
        }
    ...
    private static class AsLongHashFunction extends LongHashFunction {
        ...
        public long hashLong(long input) {
            ...
            return WyHash.INSTANCE.wyHash64(seed(), bytes, UnsafeAccess.INSTANCE, BYTE_BASE, bytes.length);
        }
        ...
        public long hashShort(short input) {
            ...
            return WyHash.INSTANCE.wyHash64(seed(), hash, UnsafeAccess.INSTANCE, BYTE_BASE, hash.length);
        }
